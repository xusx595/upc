...
*** $Author: ciancu $
*** $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/com/dvector.h $
**/

#ifndef ND_RCS_ID
#define ND_RCS_ID
#ifdef _KEEP_RCS_ID
static char *dvector_rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/com/dvector.h $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
#endif
