...
// $Author: ciancu $
// $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/com/opt_ipaa_io.h $
//
// Revision history:
...
#ifdef _KEEP_RCS_ID
static char *opt_ipaa_io_rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/com/opt_ipaa_io.h $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
