...
*** $Author: ciancu $
*** $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/com/graph_template.h $
*** 
*** Revision history:
***
...
#ifdef _KEEP_RCS_ID
static char *graph_template_rcs_id = graph_template_INCLUDED "$Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
