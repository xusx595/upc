...
*** $Revision: 1.3 $
*** $Date: 2006/03/16 07:05:40 $
*** $Author: wychen $
*** $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/com/cxx_template.h $
***
*** Revision history:
...
#ifdef _KEEP_RCS_ID
static char *cxx_templatercs_id = cxx_template_INCLUDED"$Revision: 1.3 $";
#endif /* _KEEP_RCS_ID */
...
public:
  ...
  void    AddElement (const T& val) { mUINT32 tmp = Newidx(); _array[tmp] = val; }
