...
* $Revision: 1.3 $
* $Date: 2005/10/12 21:50:40 $
* $Author: wychen $
* $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/com/opt_alias_interface.h $
*
* Revision history:
...
#ifdef _KEEP_RCS_ID
static char *opt_alias_interfacercs_id = 	opt_alias_interface_INCLUDED"$Revision: 1.3 $";
#endif /* _KEEP_RCS_ID */
...
*  ----------------------
*  
*  BOOL Points_to_same_thread(const ALIAS_MANAGER *am, WN *wn1, WN *wn2)
*    Returns TRUE if the objects accessed by the two WN node belong to 
*    the same thread
* 
*  BOOL Points_to_local(const ALIAS_MANAGER *am, WN *wn)
*    Returns TRUE if the object accessed by the WN node is local 
*  
*  BOOL Points_to_thread(const ALIAS_MANAGER *am, WN *wn, int thread_id)
*    Returns TRUE if the object accessed by the WN node is on thread thread_id
*
* ========================================================================
*/
