 ...
 * Module: cxx_base.h
 * $Revision: 1.2 $
 * $Date: 2003/06/12 22:19:32 $
 * $Author: wychen $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/com/cxx_base.h $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *cxx_basercs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/com/cxx_base.h $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
...
// Get rid of warnings from converting int to void * in 64-bit environment
// (Why is the code doing this in the first place anyway?)
#ifdef _LP64
#define CAST(x) ((INT64) x)
#else
#define CAST(x) x
#endif
