 ...
 * $Author: ciancu $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/com/betarget.h $
 *
...
#ifdef _KEEP_RCS_ID
static const char betarget_rcs_id[] = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/com/betarget.h $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
