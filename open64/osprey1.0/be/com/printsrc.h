 ...
 * $Author: ciancu $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/com/printsrc.h $
 *
 * Description:
 *
...
#ifdef _KEEP_RCS_ID
static const char rcs_id[] = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/com/printsrc.h $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
