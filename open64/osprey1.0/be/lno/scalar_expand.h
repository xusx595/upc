...
*** $Author: wychen $
*** $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/scalar_expand.h $
**/
...
#ifdef _KEEP_RCS_ID
static char *scalar_expand_rcs_id = scalar_expand_INCLUDED "$Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
