 ...
 * $Author: wychen $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/minvariant.h $
 * ====================================================================
 */
...
#ifdef _KEEP_RCS_ID
static char *minvariant = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/minvariant.h $ $Revision: 1.2 $";
#endif
#endif
