...
// $Author: phargrov $
// $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/al_loop.cxx $
//
// Revision history:
...
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/al_loop.cxx $ $Revision: 1.5 $";
#endif /* _KEEP_RCS_ID */
