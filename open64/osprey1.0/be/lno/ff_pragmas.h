...
*** $Author: wychen $
*** $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/ff_pragmas.h $
*** 
*** Description:
*** 
...
#ifdef _KEEP_RCS_ID
static char *ff_pragmas_rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/ff_pragmas.h $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
