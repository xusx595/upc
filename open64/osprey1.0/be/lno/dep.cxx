 ...
 * Module: dep.cxx  
 * $Revision: 1.3 $
 * $Date: 2005/10/25 03:07:03 $
 * $Author: ciancu $
 * $Revision: 1.3 $
 * $Date: 2005/10/25 03:07:03 $
 * $Author: ciancu $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/dep.cxx $
 *
 * Revision history:
...
static char *rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/dep.cxx $ $Revision: 1.3 $";
		     ...
		     const DOLOOP_STACK *s1, const DOLOOP_STACK *s2)
{
  ...
  if (debug >= 2) {
    ...
    fdump_tree(TFile, ref1);
    fprintf(TFile,"\n\n");
    fdump_tree(TFile, ref2);
  }
