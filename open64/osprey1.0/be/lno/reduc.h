...
*** $Author: wychen $
*** $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/reduc.h $
**/

#ifndef RED_RCS_ID
#define RED_RCS_ID
#ifdef _KEEP_RCS_ID
static char *reduc_rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/reduc.h $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
#endif
