...
/** $Revision: 1.3 $
*** $Date: 2004/01/25 22:42:53 $
*** $Author: wychen $
*** $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/model.h $
**/

#ifndef MD_RCS_ID
#define MD_RCS_ID
#ifdef _KEEP_RCS_ID
static char *model_rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/model.h $ $Revision: 1.3 $";
#endif /* _KEEP_RCS_ID */
#endif
