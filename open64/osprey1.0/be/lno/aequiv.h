...
/**
*** $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/aequiv.h $
**/

#ifndef AEQUIV_RCS_ID
#define AEQUIV_RCS_ID
#ifdef _KEEP_RCS_ID
static char *aequiv = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/aequiv.h $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
#endif
