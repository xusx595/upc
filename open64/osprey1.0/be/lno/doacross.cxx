 ...
 * $Author: wychen $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/doacross.cxx $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/doacross.cxx $";
#endif /* _KEEP_RCS_ID */
...
LWN_Delete_Tree(wn_if);
  ...
  fprintf(stderr, "has bad mem true in doacross\n");
