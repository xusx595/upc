 ...
 * Module: lnodriver.c
 * $Revision: 1.3 $
 * $Date: 2005/07/10 19:41:55 $
 * $Author: wychen $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/lnodriver.cxx $
 *
 * Revision history:
			        ...
			        WN *region_wn, BOOL alloca)
{
    ...
    if (region_wn != pu_wn) {
      ...
      sprintf(Cur_PU_Name,"%s.RGN%d", ST_name(current_pu_st),
