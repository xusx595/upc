...
*** $Author: wychen $
*** $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/lno_bv.h $
*** 
*** Revision history:
***
...
#ifdef _KEEP_RCS_ID
static char *lno_bv_rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/lno_bv.h $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
#endif
