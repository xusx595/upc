...
// $Author: wychen $
// $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/lego_opts.h $
//
// Revision history:
...
#ifdef _KEEP_RCS_ID
static char *lego_opts_rcs_id = access_vector_INCLUDED "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/lego_opts.h $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
