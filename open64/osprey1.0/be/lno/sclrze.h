...
/**
*** $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/sclrze.h $
**/

#ifndef SCLRZE_RCS_ID
#define SCLRZE_RCS_ID
#ifdef _KEEP_RCS_ID
static char *sclrze = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/sclrze.h $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
#endif
