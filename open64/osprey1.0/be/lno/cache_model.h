...
*** $Author: wychen $
*** $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/cache_model.h $
**/
...
#ifdef _KEEP_RCS_ID
static char *cache_model_rcs_id = cache_model_INCLUDED "$Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
