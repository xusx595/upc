 ...
 * $Revision: 1.2 $
 * $Date: 2003/03/04 06:15:59 $
 * $Author: wychen $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/array_lower.h $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *array_lower_rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/array_lower.h $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
