...
/** $Revision: 1.3 $
*** $Date: 2004/08/31 07:39:14 $
*** $Author: wychen $
*** $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/lno/mat.h $
**/
...
#ifdef _KEEP_RCS_ID
static char *mat_rcs_id = mat_INCLUDED "$Revision: 1.3 $";
#endif /* _KEEP_RCS_ID */
...
extern MEM_POOL LNO_local_pool;       //wei: from lnopt_main
