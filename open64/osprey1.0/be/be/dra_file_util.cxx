...
static char* DRA_basename(char *const s);

static char* DRA_dirname(char *const s);
...
DRA_Make_File_Name()
{
  ...
  char *dir = DRA_dirname(obj_file_name);
  strcpy (DRA_file_name, dir);
  strcat (DRA_file_name, DRA_DIRECTORY);

  char *base = DRA_basename(obj_file_name);
