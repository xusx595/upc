 ...
 * Module: cleanup.c
 * $Revision: 1.4 $
 * $Date: 2006/01/05 12:19:23 $
 * $Author: bonachea $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/be/cleanup.cxx $
 *
 * Revision history:
               ...
               BOOL delete_dotofile /* remove .o file ? */)
{
    ...
    if (Whirl2f_loaded)
      ...
      (defined (__MACH__) && defined (__APPLE__) ) || defined(_AIX))
