...
// Module: opt_defs.h
// $Revision: 1.4 $
// $Date: 2006/10/05 00:50:49 $
// $Author: wychen $
// $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/opt/opt_defs.h $
//
// Revision history:
...
#ifdef _KEEP_RCS_ID
static char *opt_defsrcs_id =	opt_defs_INCLUDED"$Revision: 1.4 $";
#endif /* _KEEP_RCS_ID */
