...
// $Revision: 1.3 $
// $Date: 2005/12/13 09:43:15 $
// $Author: wychen $
// $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/opt/opt_verify.cxx $
//
// Revision history:
...
Verify_version_CR(CODEREP *cr, OPT_STAB *opt_stab, BB_NODE *bb, INT32 linenum)
{
  ...
  if (opt_stab->NULL_coderep(id)) {
	...
	cr->Print(0, stderr);
	fprintf(stderr, "%s\n", ST_name(opt_stab->Aux_stab_entry(id)->St()));
