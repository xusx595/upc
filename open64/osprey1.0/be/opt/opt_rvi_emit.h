...
// $Author: wychen $
// $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/opt/opt_rvi_emit.h $
//
// ====================================================================
//
...
#ifdef _KEEP_RCS_ID
static char *opt_rvi_emitrcs_id = opt_rvi_emit_INCLUDED"$ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
