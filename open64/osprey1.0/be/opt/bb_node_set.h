...
// $Author: wychen $
// $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/opt/bb_node_set.h $
//
// ====================================================================
//
...
#ifdef _KEEP_RCS_ID
static char *bb_node_set_rcs_id =    bb_node_set_INCLUDED"$Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
