...
// $Author: wychen $
// $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/opt/idx_32_set.h $
//
// ====================================================================
//
...
#ifdef _KEEP_RCS_ID
static char *idx_32_set_rcs_id = idx_32_set_INCLUDED"$Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
