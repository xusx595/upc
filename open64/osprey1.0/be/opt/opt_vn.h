...
// Module: opt_vn.h
// $Revision: 1.4 $
// $Date: 2004/08/31 07:39:16 $
// $Author: wychen $
// $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/opt/opt_vn.h $
//
// ====================================================================
//
...
private:
   ...
   //wei: this seems wrong, shouldn't the allocator be for coderep?
   //typedef vector<CODEREP*, STMT_ALLOCATOR> CODEREP_VECTOR;
  typedef vector<CODEREP*, mempool_allocator<CODEREP*> > CODEREP_VECTOR;
