...
// $Author: wychen $
// $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/opt/opt_main.h $
//
// Revision history:
...
#ifdef _KEEP_RCS_ID
static char *opt_mainrcs_id = opt_main_INCLUDED"$Revision: 1.3 $";
#endif /* _KEEP_RCS_ID */
...
public:
  ...
  //upc specific optimization (see opt_upc_cse.h)
  void         Do_UPC_CSE(MEM_POOL* pool);
