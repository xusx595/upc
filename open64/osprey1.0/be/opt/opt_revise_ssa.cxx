...
// $Author: wychen $
// $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/opt/opt_revise_ssa.cxx $
//
// ====================================================================
//
...
OPT_REVISE_SSA::Insert_mu_and_chi_list_for_new_var(STMTREP *stmt, AUX_ID i)
{
  ...
  else if (opr == OPR_OPT_CHI && (i == _opt_stab->Default_vsym() || i == _opt_stab->Default_shared_vsym()))
    need_chi = TRUE;
