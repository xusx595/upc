 ...
 * Module: PUinfo.c
 * $Revision: 1.4 $
 * $Date: 2005/04/25 21:44:58 $
 * $Author: ciancu $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/whirl2c/PUinfo.cxx $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/whirl2c/PUinfo.cxx $ $Revision: 1.4 $";
#endif /* _KEEP_RCS_ID */
...
PUinfo_Get_ReturnPreg(TY_IDX return_ty)
{
   ...
   if (WHIRL_Return_Info_On) {
      ...
      if (Compile_Upc && TY_mtype(return_ty) == MTYPE_M) {
