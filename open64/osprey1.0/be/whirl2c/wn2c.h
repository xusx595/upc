 ...
 * Module: wn2c.h
 * $Revision: 1.3 $
 * $Date: 2006/08/30 01:58:24 $
 * $Author: wychen $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/whirl2c/wn2c.h $
 *
 * Revision history:
...
extern void emit_s2s_debug_type_info(ST *st, TOKEN_BUFFER tokens);
#endif /* wn2c_INCLUDED */
