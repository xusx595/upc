 ...
 * $Author: wychen $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/whirl2c/whirl2c_common.h $
 *
 * Revision history:
...
#define CONTEXT_PTR_ARITH 0x000000200       /* pointer arithmetic expressions, no casts needed */
