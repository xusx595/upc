 ...
 * Module: wn_attr.h
 * $Revision: 1.4 $
 * $Date: 2009/10/02 22:38:13 $
 * $Author: sjmin $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/whirl2c/wn_attr.h $
 *
 * Revision history:
...
extern TY_IDX WN_get_Tree_Type(const WN *wn, UINT);
