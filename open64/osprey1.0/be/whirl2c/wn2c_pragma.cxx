 ...
 * $Author: phargrov $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/whirl2c/wn2c_pragma.cxx $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/whirl2c/wn2c_pragma.cxx $ $Revision: 1.5 $";
#endif /* _KEEP_RCS_ID */
...
WN2C_pragma(TOKEN_BUFFER tokens, const WN *wn, CONTEXT context)
{
   ...
   if (Compile_Upc) {
     //Do not output translator internal pragma to avoid potential backend compiler warnings
     return EMPTY_STATUS;
   }
