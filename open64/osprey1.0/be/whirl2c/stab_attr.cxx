 ...
 * Module: stab_attr.c
 * $Revision: 1.13 $
 * $Date: 2006/10/26 22:19:13 $
 * $Author: wychen $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/whirl2c/stab_attr.cxx $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/be/whirl2c/stab_attr.cxx $ $Revision: 1.13 $";
#endif /* _KEEP_RCS_ID */
		   ...
		   BOOL   assign_t2_to_t1)
{
  ...
  else if ((t1 != t1_s || t2 != t2_s) && (t1_s == t2_s || &Ty_Table[t1_s] == &Ty_Table[t2_s])) {
...
Stab_Is_Equivalenced_Struct(TY_IDX ty)
{
   ...
   do {
       ...
       //fix bug1323 -- special case for empty structs
       if (fld.Is_Null()) {
	 return FALSE;
       }
