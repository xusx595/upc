 ...
 * $Revision: 1.1 $
 * $Date: 2001/10/30 16:59:47 $
 * $Author: ciancu $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/driver/config_platform.h $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *config_platform_rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/driver/config_platform.h $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
