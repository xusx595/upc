 ...
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/ipa/local/ipl_analyze_template.h $
 *
 * Description:
...
extern "C" {
void __ZN10DU_MANAGER13Get_last_stmtEj(void)  __attribute__((weak));
void __ZN10DU_MANAGER14CD_is_br_takenEj(void)  __attribute__((weak));
void __ZN10DU_MANAGER15CD_is_fall_thruEj(void) __attribute__((weak));
void __ZN10DU_MANAGER6Get_cdEj(void) __attribute__((weak));
void __ZN10DU_MANAGER8DominateEjj(void) __attribute__((weak));
void __ZNK7CODEREP12Def_at_entryEv(void) __attribute__((weak));
void __ZNK7CODEREP5DefbbEv(void) __attribute__((weak));
}	
#else 
extern "C" {
 void CD_is_br_taken_p(void) __attribute__ ((weak));
...
#endif
#else
#if defined(__MACH__) && defined(_APPLE__)
#pragma weak __ZN10DU_MANAGER13Get_last_stmtEj
#pragma weak __ZN10DU_MANAGER14CD_is_br_takenEj
#pragma weak __ZN10DU_MANAGER15CD_is_fall_thruEj
#pragma weak __ZN10DU_MANAGER6Get_cdEj
#pragma weak __ZN10DU_MANAGER8DominateEjj
#pragma weak __ZNK7CODEREP12Def_at_entryEv
#pragma weak __ZNK7CODEREP5DefbbEv
#else
