...
// PTR_ is pointer to SEG_ARRAY::value_type,
...
template <class ARRAY_Ptr, class T, class PTR_, class REF>
...
private:
    ...
    PTR_ segment_last;			// ptr after the current segment
...
public:
    ...
    PTR_ Ptr () const			{ return ptr; }
    PTR_ operator->() const              { return ptr; }
    UINT Index () const {
