 ...
 * $Author: ciancu $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/com/dwarf_DST_producer.h $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *dwarf_DST_producer_rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/com/dwarf_DST_producer.h $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
