 ...
 * $Revision: 1.2 $
 * $Date: 2003/11/03 01:33:29 $
 * $Author: wychen $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/com/config_opt.cxx $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *config_opt_rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/com/config_opt.cxx $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
...
//BOOL Enable_extract_compose=TRUE;     /* This is also forced off for MIPS and IA32 in config_targ.cxx */
BOOL Enable_extract_compose=FALSE;     /* whirl2c does not handle extract_bits */
