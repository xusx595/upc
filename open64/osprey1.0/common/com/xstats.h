 ...
 * $Author: ciancu $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/com/xstats.h $
 *
 * Description:
 *
...
#ifdef _KEEP_RCS_ID
static char *xstats_rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/com/xstats.h $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
