 ...
 * $Revision: 1.4 $
 * $Date: 2009/12/08 06:42:08 $
 * $Author: phargrov $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/com/ia64/config_targ.cxx $
 *
 *
 * Description:
 *
...
#if HOST_IS_LITTLE_ENDIAN // Let Target follow Host (for source-to-source)
