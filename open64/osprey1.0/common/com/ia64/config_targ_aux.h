 ...
 * $Revision: 1.1 $
 * $Date: 2005/10/11 01:36:53 $
 * $Author: ciancu $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/com/ia64/config_targ_aux.h $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *config_TARG_h_rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/com/ia64/config_targ_aux.h $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
