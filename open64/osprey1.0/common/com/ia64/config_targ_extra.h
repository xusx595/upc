...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *config_TARG_h_rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/com/ia64/config_targ_extra.h $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
