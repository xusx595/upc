 ...
 * $Revision: 1.5 $
 * $Date: 2009/12/04 22:23:29 $
 * $Author: phargrov $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/com/config_host.h $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *config_host_rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/com/config_host.h $ $Revision: 1.5 $";
#endif /* _KEEP_RCS_ID */
...
//FIXME: so may need extra cases if __BIG_ENDIAN__ is not accurate
