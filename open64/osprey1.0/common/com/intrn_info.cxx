...
intrn_info_t intrn_info[INTRINSIC_LAST+1] = {
  ...
  { /* I4DIVFLOOR */
	BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_I4, "_I4DIVFLOOR", "INTRN_I4DIVFLOOR", "_I4DIVFLOOR"},
  { /* I8DIVFLOOR */
	BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_I8, "_I8DIVFLOOR", "INTRN_I8DIVFLOOR", "_I8DIVFLOOR"},
  { /* U4DIVFLOOR */
	BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
  ...
  { /* I4DIVCEIL */
	BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_I4, "_I4DIVCEIL", "INTRN_I4DIVCEIL", "_I4DIVCEIL"},
  { /* I8DIVCEIL */
	BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_I8, "_I8DIVCEIL", "INTRN_I8DIVCEIL", "_I8DIVCEIL"},
  { /* U4DIVCEIL */
	BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
  ...
  { /* EXIT */
    	BYVAL, PURE, SIDEEFFECTS, NEVER_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
  ...
  { /* ALL_ALLOC */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_M, /*NULL*/"upc_all_alloc", "ALL_ALLOC", "upc_all_alloc"},
  { /* GLOBAL_ALLOC */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_M, /*NULL*/"upc_global_alloc", "GLOBAL_ALLOC", "upc_global_alloc"},
  { /* LOCAL_ALLOC */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_M, /*NULL*/"upc_alloc", "LOCAL_ALLOC", "upc_alloc"},
  { /* FREE */
    BYVAL, PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"upc_free", "FREE", "upc_free"},
  { /* THREADOF_S */
    BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
  ...
  { /* G_LOCK_ALLOC */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_M, /*NULL*/"upc_global_lock_alloc", "G_LOCK_ALLOC", "upc_global_lock_alloc"},
  { /* A_LOCK_ALLOC */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_M, /*NULL*/"upc_all_lock_alloc", "A_LOCK_ALLOC", "upc_all_lock_alloc"},
  { /* LOCK_FREE */
    BYVAL, PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"upc_lock_free", "LOCK_FREE", "upc_lock_free"},
  { /* LOCK */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"upc_lock", "LOCK", "upc_lock"},
  { /* LOCK_ATTEMPT */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_I4, /*NULL*/"upc_lock_attempt", "LOCK_ATTEMPT", "upc_lock_attempt"},
  { /* UNLOCK */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"upc_unlock", "UNLOCK", "upc_unlock"},
  { /* MEMCPY */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"upc_memcpy", "UPC_MEMCPY", "upc_memcpy"},
  { /* MEMGET */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"upc_memget", "UPC_MEMGET", "upc_memget"},
  { /* MEMPUT */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"upc_memput", "UPC_MEMPUT", "upc_memput"},
  { /* MEMSET */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"upc_memset", "UPC_MEMSET", "upc_memset"},
  { /* S_TO_L -- RTYPE*/
    BYVAL, PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
  ...
  { /* S_RESET */
    BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_M, /*NULL*/"upc_resetphase", "S_RESET", "upc_resetphase"},
  { /* S_RESET_REF */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
 ...
 { /* GET_S_VAL --RTYPE */
  ...
  { /* GET_P_DVAL */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_F8, /*NULL*/"UPCR_GET_PSHARED_DOUBLEVAL", "GET_P_DVAL", "UPCR_GET_PSHARED_DOUBLEVAL"},
  { /* WAIT_SYN_VAL */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
 ...
 /* strict blocking loads */
  { /* SILDS */
    	BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_I8, /*NULL*/"UPCR_GET_SHARED_VAL_STRICT", "SILDS", "UPCR_GET_SHARED_VAL_STRICT"},
  { /* SF4LDS */
    	BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_F4, /*NULL*/"UPCR_GET_SHARED_FLOAT_STRICT", "SF4LDS", "UPCR_GET_SHARED_FLOAT_STRICT"},
  { /* SF8LDS */
    	BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_F8, /*NULL*/"UPCR_GET_SHARED_DOUBLEVAL_STRICT", "SF8LDS", "UPCR_GET_SHARED_DOUBLEVAL_STRICT"},
  { /* SMLDS */
    	BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_V, /*NULL*/"UPCR_GET_SHARED_STRICT", "SMLDS", "UPCR_GET_SHARED_STRICT"},

  /* strict blocking stores */
  { /* SISTS */
    	BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_V, /*NULL*/"UPCR_PUT_SHARED_VAL_STRICT", "SI1STS", "UPCR_PUT_SHARED_VAL_STRICT"},
  { /* SF4STS */
    	BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_V, /*NULL*/"UPCR_PUT_SHARED_FLOAT_STRICT", "SF4STS", "UPCR_PUT_SHARED_FLOAT_STRICT"},
  { /* SF8STS */
    	BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_V, /*NULL*/"UPCR_PUT_SHARED_DOUBLEVAL_STRICT", "SF8STS", "UPCR_PUT_SHARED_DOUBLEVAL_STRICT"},
  { /* SMSTS */
    	BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_V, /*NULL*/"UPCR_PUT_SHARED_STRICT", "SMSTS", "UPCR_PUT_SHARED_STRICT"},

/* strict non-blocking loads */
{ /* SILD_NBS */
    	BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_I8, /*NULL*/"UPCR_GET_NB_SHARED_VAL_STRICT", "SILD_NBS", "UPCR_GET_NB_SHARED_VAL_STRICT"},
  { /* SF4LD_NBS */
    	BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_I8, /*NULL*/"UPCR_GET_NB_SHARED_FLOAT_STRICT", "SF4LD_NBS", "UPCR_GET_NB_SHARED_FLOAT_STRICT"},
  { /* SF8LD_NBS */
    	BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_I8, /*NULL*/"UPCR_GET_NB_SHARED_DOUBLE_STRICT", "SF8LD_NBS", "UPCR_GET_NB_SHARED_DOUBLE_STRICT"},
  { /* SMLD_NBS */
    	BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_I8, /*NULL*/"UPCR_GET_NB_SHARED_STRICT", "SMLD_NBS", "UPCR_GET_NB_SHARED_STRICT"},

 /* strict non-blocking stores */
  { /* SIST_NBS */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_I8, /*NULL*/"UPCR_PUT_NB_SHARED_VAL_STRICT", "SI1STS", "UPCR_PUT_NB_SHARED_VAL_STRICT"},
  { /* SF4ST_NBS */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_I8, /*NULL*/"UPCR_PUT_NB_SHARED_FLOAT_STRICT", "SF4STS", "UPCR_PUT_NB_SHARED_FLOAT_STRICT"},
  { /* SF8ST_NBS */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_I8, /*NULL*/"UPCR_PUT_NB_SHARED_DOUBLE_STRICT", "SF8STS", "UPCR_PUT_NB_SHARED_DOUBLE_STRICT"},
  { /* SMST_NBS */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_I8, /*NULL*/"UPCR_PUT_NB_SHARED_STRICT", "SMSTS", "UPCR_PUT_NB_SHARED_STRICT"},

    /* strict put/get syncs */
  { /* SYNC_MEMS */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"UPCR_WAIT_SYNCNB_STRICT", "SYNC_MEMS", "UPCR_WAIT_SYNCNB_STRICT"},
  { /* SYNC_REG */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_I8, /*NULL*/"UPCR_WAIT_SYNCNB_VALGET_STRICT", "SYNC_REGS", "UPCR_WAIT_SYNCNB_VALGET_STRICT"},
  { /* SYNC_FLOAT */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_F4, /*NULL*/"UPCR_WAIT_SYNCNB_VALGET_FLOAT_STRICT", "SYNC_FLOATS", "UPCR_WAIT_SYNCNB_VALGET_FLOAT_STRICT"},
  { /* SYNC_DOUBLE */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_F8, /*NULL*/"UPCR_WAIT_SYNCNB_VALGET_DOUBLE_STRICT", "SYNC_DOUBLES", "UPCR_WAIT_SYNCNB_VALGET_DOUBLE_STRICT"},
 
    /* strict versions */

 { /* PUT_SS */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"UPCR_PUT_SHARED_STRICT", "PUT_SS", "UPCR_PUT_SHARED_STRICT"},
  { /* PUT_PS */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"UPCR_PUT_PSHARED_STRICT", "PUT_PS", "UPCR_PUT_PSHARED_STRICT"},
  { /* GET_SS */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"UPCR_GET_SHARED_STRICT", "GET_SS", "UPCR_GET_SHARED_STRICT"},
  { /* GET_PS */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"UPCR_GET_PSHARED_STRICT", "GET_PS", "UPCR_GET_PSHARED_STRICT"},
  { /* PUT_NB_SS --RTYPE*/
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    sizeof(int) == 4 ? IRETURN_I4 : IRETURN_I8, /*NULL*/"UPCR_PUT_NB_SHARED_STRICT", "PUT_NB_SS", "UPCR_PUT_NB_SHARED_STRICT"},
  { /* GET_NB_SS --RTYPE*/
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    sizeof(int) == 4 ? IRETURN_I4 : IRETURN_I8, /*NULL*/"UPCR_GET_NB_SHARED_STRICT", "GET_NB_SS", "UPCR_GET_NB_SHARED_STRICT"},
  { /* PUT_NB_PS --RTYPE*/
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    sizeof(int) == 4 ? IRETURN_I4 : IRETURN_I8, /*NULL*/"UPCR_PUT_NB_PSHARED_STRICT", "PUT_NB_PS", "UPCR_PUT_NB_PSHARED_STRICT"},
  { /* GET_NB_PS --RTYPE*/
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    sizeof(int) == 4 ? IRETURN_I4 : IRETURN_I8, /*NULL*/"UPCR_GET_NB_PSHARED_STRICT", "GET_NB_PS", "UPCR_GET_NB_PSHARED_STRICT"},
  { /* WAIT_SYNS */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"UPCR_WAIT_SYNCNB_STRICT", "WAIT_SYNS", "UPCR_WAIT_SYNCNB_STRICT"},
  { /* TRY_SYNS */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    sizeof(int) == 4 ? IRETURN_I4 : IRETURN_I8, /*NULL*/"UPCR_TRY_SYNCNB_STRICT", "TRY_SYNS", "UPCR_TRY_SYNCNB_STRICT"},

    { /* PUT_S_VALS */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"UPCR_PUT_SHARED_VAL_STRICT", "PUT_S_VALS", "UPCR_PUT_SHARED_VAL_STRICT"},
  { /* PUT_NB_S_VALS --RTYPE*/
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    sizeof(int) == 4 ? IRETURN_I4 : IRETURN_I8, /*NULL*/"UPCR_PUT_NB_SHARED_VAL_STRICT", "PUT_NB_S_VALS", "UPCR_PUT_NB_SHARED_VAL_STRICT"},
    
{ /* PUT_P_VALS */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"UPCR_PUT_PSHARED_VAL_STRICT", "PUT_P_VALS", "UPCR_PUT_PSHARED_VAL_STRICT"},
  { /* PUT_NB_P_VALS --RTYPE */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    sizeof(int) == 4 ? IRETURN_I4 : IRETURN_I8, /*NULL*/"UPCR_PUT_NB_PSHARED_VAL_STRICT", "PUT_NB_P_VALS", "UPCR_PUT_NB_PSHARED_VAL_STRICT"},

/* STRICT versions */
    { /* GET_S_VALS --RTYPE */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    sizeof(int) == 4 ? IRETURN_I4 : IRETURN_I8, /*NULL*/"UPCR_GET_SHARED_VAL_STRICT", "GET_S_VALS", "UPCR_GET_SHARED_VAL_STRICT"},
  { /* GET_P_VALS --RTYPE */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    sizeof(int) == 4 ? IRETURN_I4 : IRETURN_I8, /*NULL*/"UPCR_GET_PSHARED_VAL_STRICT", "GET_P_VALS", "UPCR_GET_PSHARED_VAL_STRICT"},
  { /* GET_NB_S_VALS --RTYPE */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    sizeof(int) == 4 ? IRETURN_I4 : IRETURN_I8, /*NULL*/"UPCR_GET_NB_SHARED_VAL_STRICT", "GET_NB_S_VALS", "UPCR_GET_NB_SHARED_VAL_STRICT"},
  { /* GET_NB_P_VALS --RTYPE */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    sizeof(int) == 4 ? IRETURN_I4 : IRETURN_I8, /*NULL*/"UPCR_GET_NB_PSHARED_VAL_STRICT", "GET_NB_P_VALS", "UPCR_GET_NB_PSHARED_VAL_STRICT"},
  { /* PUT_S_FVALS */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"UPCR_PUT_SHARED_FLOATVAL_STRICT", "PUT_S_FVALS", "UPCR_PUT_SHARED_FLOATVAL_STRICT"},
  { /* PUT_S_DVALS */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"UPCR_PUT_SHARED_DOUBLEVAL_STRICT", "PUT_S_DVALS", "UPCR_PUT_SHARED_DOUBLEVAL_STRICT"},
  { /* GET_S_FVALS */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_F4, /*NULL*/"UPCR_GET_SHARED_FLOATVAL_STRICT", "GET_S_FVALS", "UPCR_GET_SHARED_FLOATVAL_STRICT"},
  { /* GET_S_DVALS */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_F8, /*NULL*/"UPCR_GET_SHARED_DOUBLEVAL_STRICT", "GET_S_DVALS", "UPCR_GET_SHARED_DOUBLEVAL_STRICT"},
  { /* PUT_P_FVALS */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"UPCR_PUT_PSHARED_FLOATVAL_STRICT", "PUT_P_FVALS", "UPCR_PUT_PSHARED_FLOATVAL_STRICT"},
  { /* PUT_P_DVALS */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"UPCR_PUT_PSHARED_DOUBLEVAL_STRICT", "PUT_P_DVALS", "UPCR_PUT_PSHARED_DOUBLEVAL_STRICT"},
  { /* GET_P_FVALS */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_F4, /*NULL*/"UPCR_GET_PSHARED_FLOATVAL_STRICT", "GET_P_FVALS", "UPCR_GET_PSHARED_FLOATVAL_STRICT"},
  { /* GET_P_DVALS */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_F8, /*NULL*/"UPCR_GET_PSHARED_DOUBLEVAL_STRICT", "GET_P_DVALS", "UPCR_GET_PSHARED_DOUBLEVAL_STRICT"},
  { /* WAIT_SYN_VALS */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
      IRETURN_V, /*NULL*/"UPCR_WAIT_SYNCNB_VALGET_STRICT", "WAIT_SYN_VALS", "UPCR_WAIT_SYNCNH_VALGET_STRICT"},

  { /* MEMGET_STRIDE */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"bupc_memget_fstrided", "MEMGET_STRIDE", "bupc_memget_fstrided"},
  { /* MEMPUT_STRIDE */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"bupc_memput_fstrided", "MEMGET_STRIDE", "bupc_memput_fstrided"},
  { /* MEMCPY_STRIDE */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"bupc_memcpy_fstrided", "MEMCPY_STRIDE", "bupc_memcpy_fstrided"},
  { /* MEMGET_ILIST */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"upcr_memget_ilist", "MEMGET_ILIST", "upcr_memget_ilist"},
  { /* MEMPUT_ILIST */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"upcr_memput_ilist", "MEMPUT_ILIST", "upcr_memput_ilist"},
  { /* MEMCPY_ILIST */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"upcr_memcpy_ilist", "MEMCPY_ILIST", "upcr_memcpy_ilist"},
  { /* MEMGET_VLIST */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"upcr_memget_vlist", "MEMGET_VLIST", "upcr_memget_vlist"},
  { /* MEMPUT_VLIST */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"upcr_memput_vlist", "MEMPUT_VLIST", "upcr_memput_vlist"},
  { /* MEMCPY_VLIST */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"upcr_memcpy_vlist", "MEMCPY_VLIST", "upcr_memcpy_vlist"},
  { /* MEMGET_NBI */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"upcr_nbi_memget", "MEMGET_NBI", "upcr_nbi_memget"},
  { /* MEMPUT_NBI */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"upcr_nbi_memput", "MEMPUT_NBI", "upcr_nbi_memput"},
  { /* MEMCPY_NBI */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"upcr_nbi_memcpy", "MEMCPY_NBI", "upcr_nbi_memcpy"},

  { /* AFF_SIZE */
    BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_I8, /*NULL*/"upc_affinitysize", "AFF_SIZE", "upc_affinitysize"},

  { /* VECT_ALLOC */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_M, /*NULL*/"malloc", "VECT_ALLOC", "malloc"},

  { /* VECT_FREE */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"free", "VECT_FREE", "free"},

  { /* GCD */
    BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_I4, /*NULL*/"upcrt_gcd", "GCD", "upcrt_gcd"},

  { /* FORALL_START */
    BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_I4, /*NULL*/"upcrt_forall_start", "FORALL_MY_START", "upcrt_forall_start"},

   { /* COMPUTE_BB*/
    BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_I4, /*NULL*/"upcr_compute_bb", "COMPUTE_BB", "upcr_compute_bb"},

   { /* AUTO_NB_MEMPUT */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"upcrt_memput_nb", "AUTO_NB_MEMPUT", "upcrt_memput_nb"},

   { /* AUTO_NB_MEMGET */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, /*NULL*/"upcrt_memget_nb", "AUTO_NB_MEMGET", "upcrt_memget_nb"},
   
{ /* VEC_START_LN */
    BYVAL, PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
      IRETURN_I4, "upcrt_start_nest", "VEC_START_LN", "upcrt_start_nest"},  
  {
    BYVAL, PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_I4, "upcrt_new_base_ref", "VEC_NEW_BR", "upcrt_new_base_ref"},
  {
    BYVAL, PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, "upcrt_add_sos_dim", "VEC_ADD_SDIM", "upcrt_add_sos_dim"},
  {
    BYVAL, PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, "upcrt_add_polytope_dim", "VEC_ADD_PDIM", "upcrt_add_polytope_dim"},
  {
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_I4, "upcrt_analyze_transfers", "VEC_ANAL", "upcrt_analyze_transfers"},
  {
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, "upcrt_advance_dim", "VEC_ADVD", "upcrt_advance_dim"},
 {
   BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, "upcrt_end_nest", "VEC_ENEST", "upcrt_end_nest"},
{
  BYVAL, PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_I4, "upcrt_new_lmad", "VEC_NEW_LMAD", "upcrt_new_lmad"},
{
   BYVAL, PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_PV, "upcrt_get_local_address", "VEC_GET_LADDR", "upcrt_get_local_address"},
{
  BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, "upcrt_finalize_dim", "VEC_FIND", "upcrt_finalize_dim"},
{
  BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_I4, "upcrt_new_strips", "VEC_GETSTR", "upcrt_get_strips"},
{
  BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_I4, "upcrt_get_coeff", "VEC_GET_COEFF", "upcrt_get_coeff"},

  //The new type-based get/put interface
  { /* GET_P_TYPE */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, "upcr_get_pshared_type", "GET_P_TYPE", "upcr_get_pshared_type"},

  { /* GET_P_TYPE_S */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, "upcr_get_pshared_type_strict", "GET_P_TYPE", "upcr_get_pshared_type_strict"},

  { /* PUT_P_TYPE */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, "upcr_put_pshared_type", "PUT_P_TYPE", "upcr_put_pshared_type"},

  { /* PUT_P_TYPE_S */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    IRETURN_V, "upcr_put_pshared_type_strict", "PUT_P_TYPE_S", "upcr_put_pshared_type_strict"},

  { /* GET_NB_P_TYPE */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    sizeof(int) == 4 ? IRETURN_I4 : IRETURN_I8, "upcr_get_nb_pshared_type", "GET_NB_P_TYPE", "upcr_get_nb_pshared_type"},

  { /* GET_NB_P_TYPE_S */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
    sizeof(int) == 4 ? IRETURN_I4 : IRETURN_I8, "upcr_get_nb_pshared_type_strict", "GET_NB_P_TYPE", "upcr_get_nb_pshared_type_strict"},

  { /* PUT_NB_P_TYPE */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
      sizeof(int) == 4 ? IRETURN_I4 : IRETURN_I8, "upcr_put_nb_pshared_type", "PUT_NB_P_TYPE", "upcr_put_nb_pshared_type"},

  { /* PUT_NB_P_TYPE_S */
    BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
      sizeof(int) == 4 ? IRETURN_I4 : IRETURN_I8, "upcr_put_nb_pshared_type_strict", "PUT_NB_P_TYPE", "upcr_put_nb_pshared_type_strict"},
...
/* added by parkcs for UPC-Thrille extensions */
{
	BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_V, "THRILLE_BEFORE_LREAD", "UPCT_BEFORE_LREAD", "THRILLE_BEFORE_LREAD"},
{
	BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_V, "THRILLE_AFTER_LREAD", "UPCT_AFTER_LREAD", "THRILLE_AFTER_LREAD"},
{
	BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_V, "THRILLE_BEFORE_LWRITE", "UPCT_BEFORE_LWRITE", "THRILLE_BEFORE_LWRITE"},
{
	BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, NOT_CGINTRINSIC,
	IRETURN_V, "THRILLE_AFTER_LWRITE", "UPCT_AFTER_LWRITE", "THRILLE_AFTER_LWRITE"},
/* end parkcs */
}; //end of intrinsics
