 ...
 * $Author: phargrov $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/com/config.cxx $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/com/config.cxx $ $Revision: 1.4 $";
#endif /* _KEEP_RCS_ID */
...
BOOL Run_thrille = FALSE;		/* run UPC-Thrille instrumentation -- added by parkcs */
  ...
  /**  NOTE: filename CAN BE NULL */
{
  ...
  if(Compile_Upc) // this  allows ptr arith operations to be simplified 
                  // which causes problems with structs and PTS
    Enable_Cfold_Aggressive = FALSE;
