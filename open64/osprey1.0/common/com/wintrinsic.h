...
/** $Revision: 1.32 $
*** $Date: 2012/04/28 01:48:21 $
*** $Author: phargrov $
*** $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/com/wintrinsic.h $
**/
...
/* Super Computing ABI Intrinsics */
  ...
  INTRN_SUB_PI = 881,
   ...
   /* UPC strict blocking loads */
  INTRN_SILDS     = 882,
  INTRN_SF4LDS     = 883,
  INTRN_SF8LDS     = 884,
  INTRN_SMLDS      = 885,
  
  /* UPC strict blocking stores */
  INTRN_SISTS     = 886,
  INTRN_SF4STS     = 887,
  INTRN_SF8STS     = 888,
  INTRN_SMSTS      = 889,
  
  /* UPC strict non-blocking loads */
  INTRN_SILD_NBS = 890,
  INTRN_SF4LD_NBS = 891,
  INTRN_SF8LD_NBS = 892,
  INTRN_SMLD_NBS = 893,

  /* UPC strict non-blocking strores */
  INTRN_SIST_NBS = 894,
  INTRN_SF4ST_NBS = 895,
  INTRN_SF8ST_NBS = 896,
  INTRN_SMST_NBS = 897,

  /* UPC strict put/get syncs */
  INTRN_WAIT_SYNC_MEMS = 898,
  INTRN_WAIT_SYNC_REGS = 899,
  INTRN_WAIT_SYNC_FLOATS = 900,
  INTRN_WAIT_SYNC_DOUBLES = 901,

   /* UPC strict shared memory accesses */
  INTRN_PUT_SS = 902,
  INTRN_PUT_PS = 903,
  INTRN_GET_SS = 904,
  INTRN_GET_PS = 905,

  /* UPC strict non-blocking shared memory accesses */
  INTRN_PUT_NB_SS = 906,
  INTRN_GET_NB_SS = 907,
  INTRN_PUT_NB_PS = 908,
  INTRN_GET_NB_PS = 909,
  ...
  INTRN_TRY_SYNS = 911,
   ...
   /* UPC strict register memory operations */
  INTRN_PUT_S_VALS = 912,
  INTRN_PUT_NB_S_VALS = 913,
  INTRN_PUT_P_VALS = 914,
  INTRN_PUT_NB_P_VALS = 915,
  INTRN_GET_S_VALS = 916,
  INTRN_GET_P_VALS = 917,
  INTRN_GET_NB_S_VALS = 918,
  INTRN_GET_NB_P_VALS = 919,

  /* UPC strict float/double memory operations */
  INTRN_PUT_S_FVALS = 920,
  INTRN_PUT_S_DVALS = 921,
  INTRN_GET_S_FVALS = 922,
  INTRN_GET_S_DVALS = 923,
  INTRN_PUT_P_FVALS = 924,
  INTRN_PUT_P_DVALS = 925,
  INTRN_GET_P_FVALS = 926,
  INTRN_GET_P_DVALS = 927,
  INTRN_WAIT_SYN_VALS = 928,
  
  //UPC memcpy extensions 
  INTRN_MEMGET_STRIDE = 929,
  INTRN_MEMPUT_STRIDE = 930,
  INTRN_MEMCPY_STRIDE = 931,
  INTRN_MEMGET_ILIST = 932,
  INTRN_MEMPUT_ILIST = 933,
  INTRN_MEMCPY_ILIST = 934,
  INTRN_MEMGET_VLIST = 935,
  INTRN_MEMPUT_VLIST = 936,
  INTRN_MEMCPY_VLIST = 937,

  INTRN_MEMGET_NBI = 938,
  INTRN_MEMPUT_NBI = 939,
  INTRN_MEMCPY_NBI = 940,

  INTRN_AFF_SIZE = 941,

  //allocation/free functions for message vectorization
  INTRN_VECT_ALLOC = 942,
  INTRN_VECT_FREE = 943,

  //runtime functions supporting upc_forall optimizations
  INTRN_GCD = 944,
  INTRN_FORALL_START = 945,
  INTRN_BB = 946,

  //automatic nonblocking memput
  INTRN_AUTO_NB_MEMPUT = 947,
  INTRN_AUTO_NB_MEMGET = 948,
  
  INTRN_VEC_START_LN = 949,
  INTRN_VEC_NEW_BR = 950,
  INTRN_VEC_ADD_SDIM = 951,
  INTRN_VEC_ADD_PDIM = 952,
  INTRN_VEC_ANAL = 953,
  INTRN_VEC_ADVD = 954,
  INTRN_VEC_ENEST = 955,
  INTRN_VEC_NEW_LMAD = 956,
  INTRN_VEC_GET_LADDR = 957,
  INTRN_VEC_FIND = 958,
  INTRN_VEC_GETSTR = 959,
  INTRN_VEC_GET_COEFF = 960,

  //type based get/put
  INTRN_GET_P_TYPE = 961, 
  INTRN_GET_P_TYPE_S = 962,
  INTRN_PUT_P_TYPE = 963,
  INTRN_PUT_P_TYPE_S = 964,
  INTRN_GET_NB_P_TYPE = 965, 
  INTRN_GET_NB_P_TYPE_S = 966,
  INTRN_PUT_NB_P_TYPE = 967,
  ...
  /* added by parkcs for UPC-Thrille extensions to privatized accesses */
  INTRN_UPCT_BEFORE_LREAD = 978,
  INTRN_UPCT_AFTER_LREAD = 979,
  INTRN_UPCT_BEFORE_LWRITE = 980,
  INTRN_UPCT_AFTER_LWRITE = 981,
  /* end parkcs */
