 ...
 * Module: ir_reader.h
 * $Revision: 1.2 $
 * $Date: 2003/05/05 02:27:17 $
 * $Author: ciancu $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/com/ir_reader.h $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *opt_irrcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/com/ir_reader.h $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
...
extern void  print_upc_source(SRCPOS srcpos);
/* for debugging */
