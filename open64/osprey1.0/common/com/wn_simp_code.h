...
#undef log2 /* E.g. for Cygwin's math.h: #define log2(x) (log (x) / M_LOG2_E) -PHH */
...
static simpnode SIMPNODE_SimplifyExp2_h(OPCODE opc, simpnode k0, simpnode k1) 
{
	...
	**********************************/
	 ...
	 if (!k1const &&
	   ...
	   //This is apparently not needed anymore (made superfluous by bug1307 fix?),
	   //and is wrong anyway since t0 could be a CODEREP
	   //if (tas_idx) {
