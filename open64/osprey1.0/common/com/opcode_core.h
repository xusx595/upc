...
*** $Author: ciancu $
*** $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/com/opcode_core.h $
**/
...
#ifdef _KEEP_RCS_ID
static char *opcode_core_rcs_id = opcode_core_INCLUDED "$Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
