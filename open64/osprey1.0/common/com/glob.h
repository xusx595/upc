 ...
 * Module: glob.h
 * $Revision: 1.5 $
 * $Date: 2003/05/30 22:58:50 $
 * $Author: wychen $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/com/glob.h $
 *
 * Revision history:
...
/* indicates whether we want to use TLD_ADDR or not */
extern BOOL use_TLD;
