 ...
 * Module: wn_pragmas.h
 * $Revision: 1.6 $
 * $Date: 2006/07/19 03:44:39 $
 * $Author: ciancu $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/com/wn_pragmas.h $
 *
 * Description:
 *
...
static char *pragmas_rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/com/wn_pragmas.h $ $Revision: 1.6 $";
...
/* CRAY pragmas */
  ...
  WN_PRAGMA_UPC_NO_RL_ALIAS,         /* for vectorization, specify that shared ptrs are
					not aliased to local ptrs  */
  WN_PRAGMA_GENERIC,                  /* generic pragmas that we wish to pass to the backend C compiler 
					 WN_st() stores a constant string representing the pragma
				       */
