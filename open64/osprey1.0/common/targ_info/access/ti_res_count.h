 ...
 *  $Author: ciancu $
 *  $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/targ_info/access/ti_res_count.h $
 *
 *  Revision history:
...
#ifdef _KEEP_RCS_ID
static const char ti_res_count_rcs_id[] = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/targ_info/access/ti_res_count.h $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
