 ...
 *  $Author: ciancu $
 *  $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/targ_info/access/ti_errors.h $
 *
 *  Synopsis:
 *
...
#ifdef _KEEP_RCS_ID
static const char ti_errors_rcs_id[] = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/targ_info/access/ti_errors.h $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
