...
//  $Author: ciancu $
//  $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/targ_info/generate/isa_hazards_gen.h $
...
#ifdef _KEEP_RCS_ID
static const char isa_hazards_gen_rcs_id[] = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/targ_info/generate/isa_hazards_gen.h $ $Revision: 1.1 $";
#endif
#endif
