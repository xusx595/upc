...
// Needed for <string.h> to expose strsignal() on some linux systems
#ifndef _GNU_SOURCE
#define _GNU_SOURCE
#endif
...
#elif defined(__digital__) || defined(__osf__) //on Tru64, gcc3.0 defines the latter but not the former
# define I_USE_THE_CRUSTY_SYS_SIGLIST_ARRAY 1
