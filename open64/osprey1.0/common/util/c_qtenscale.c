 ...
 * Module: c_qtenscale:
 * $Revision: 1.6 $
 * $Date: 2010/05/21 05:27:20 $
 * $Author: phargrov $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/util/c_qtenscale.c $
 *
 * Revision history:
...
static char *rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/util/c_qtenscale.c $ $Revision: 1.6 $";
