 ...
 *  $Author: ciancu $
 *  $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/util/x_list.c $
 *
 *  Revision comments:
 *
...
static char *rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/util/x_list.c $ $Revision: 1.1 $";
