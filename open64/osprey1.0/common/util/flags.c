 ...
 * Module: flags.c
 * $Revision: 1.3 $
 * $Date: 2004/01/25 22:43:04 $
 * $Author: wychen $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/util/flags.c $
 *
 * Revision history:
...
static const char rcs_id[] = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/util/flags.c $ $Revision: 1.3 $";
#endif
