 ...
 * Module: tracing.c
 * $Revision: 1.4 $
 * $Date: 2003/04/10 18:43:13 $
 * $Author: wychen $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/util/tracing.c $
 *
 * Revision history:
...
static char *rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/util/tracing.c $ $Revision: 1.4 $";
