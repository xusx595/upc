...
*** $Author: ciancu $
*** $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/util/priority_queue.h $
**/
...
#ifndef PRQ_RCS_ID
#define PRQ_RCS_ID
static const char prq_rcs_id[] = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/common/util/priority_queue.h $ $Revision: 1.1 $";
#endif
#endif
