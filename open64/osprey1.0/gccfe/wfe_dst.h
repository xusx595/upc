 ...
 * Module: wfe_dst.h
 * $Revision: 1.13 $
 * $Date: 2005/10/04 09:34:33 $
 * $Author: wychen $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/gccfe/wfe_dst.h $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *wfe_dst_rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/gccfe/wfe_dst.h $ $Revision: 1.13 $";
#endif /* _KEEP_RCS_ID */
...
/* store a list of global-scope pragmas */
extern vector<WN*> global_pragmas; 
...
extern void WFE_Set_Line_And_File (unsigned int line, char *file);
  ...
  extern void WFE_Add_Pragma(const char* name);
  extern void WFE_Add_Bupc_Pragma(const char* name);

  extern void WFE_Pop_Pragma();
  extern void WFE_Push_Pragma();
