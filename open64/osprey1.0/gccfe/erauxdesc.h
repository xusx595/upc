 ...
 * $Author: ciancu $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/gccfe/erauxdesc.h $
 *
 * Revision history:
...
static char *eraux_desc_rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/gccfe/erauxdesc.h $ $Revision: 1.1 $";
