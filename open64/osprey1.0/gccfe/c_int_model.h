 ...
 * $Revision: 1.1 $
 * $Date: 2001/10/30 16:59:48 $
 * $Author: ciancu $
 * $Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/gccfe/c_int_model.h $
 *
 * Revision history:
 *  ??-???-92 - Original Version
 *
...
#ifdef _KEEP_RCS_ID
static char *c_int_model_rcs_id = "$Source: bitbucket.org:berkeleylab/upc-translator.git/open64/osprey1.0/gccfe/c_int_model.h $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
