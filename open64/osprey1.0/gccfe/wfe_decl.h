...
extern void WFE_Add_Aggregate_Init_Integer (INT64 val, INT size, INT is_unsigned);
...
void WFE_Finish_Inner_Scope();
void WFE_Start_Inner_Scope();
extern  void WFE_Patch_File_Statics();
