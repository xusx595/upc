...
#ifndef __linux__
// Non-Linux systems do not like __THROW
#define __THROW
#endif

#if defined(__CYGWIN__)
// Have this decl (and it conflicts with the one in this file)
...
#define GCCBUGURL "<URL:http://upc-bugs.lbl.gov/>"
...
#ifdef linux
//at least for Tru64, fputs_unlocked is not supported, and fputs should be used instead
# undef fputs
# define fputs(String, Stream) fputs_unlocked (String, Stream)
#endif
//fputs_unlocked is apparently never used...
