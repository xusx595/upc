...
/* Check and correct (for instance LONG needs correction for PPC32 builds) */
#if defined(_MIPS_SZINT) && (HOST_BITS_PER_INT != _MIPS_SZINT)
#undef HOST_BITS_PER_INT
#define HOST_BITS_PER_INT _MIPS_SZINT
#endif
#if defined(_MIPS_SZLONG) && (HOST_BITS_PER_LONG != _MIPS_SZLONG)
#undef HOST_BITS_PER_LONG
#define HOST_BITS_PER_LONG _MIPS_SZLONG
#endif

/* Now double check */
#if defined(SIZEOF_INT) && (HOST_BITS_PER_INT != 8*SIZEOF_INT)
#error BAD SIZEOF_INT
#endif
#if defined(SIZEOF_LONG) && (HOST_BITS_PER_LONG != 8*SIZEOF_LONG)
#error BAD SIZEOF_LONG
#endif
